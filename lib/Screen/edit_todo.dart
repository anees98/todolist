...
class EditTodoList extends StatefulWidget {
  const EditTodoList({Key? key, required this.title, required this.index}) : super(key: key);
  final String title;
  final int index;
...
class _EditTodoListState extends State<EditTodoList> {
  ...
  void onUpdateNow(){
    ...
    setState(() {
      listtodo![widget.index].todotitle = todoTitleCtl.text;
      listtodo![widget.index].startDate = initStartdate;
      listtodo![widget.index].endDate = initEnddate;
      listtodo![widget.index].timeLeft = durationToString(difference);
  ...
  void onInit(){
   todoTitleCtl.text = listtodo![widget.index].todotitle;
   initStartdate = listtodo![widget.index].startDate;
   initEnddate = listtodo![widget.index].endDate;
  }
